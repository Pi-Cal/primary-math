        ...
        case 1: {
            return (
                <div className='mt-3 container'>
                    ...
                    <Image fluid src={process.env.PUBLIC_URL + "/example/anh-1-bai-toan-trong-cay.png"} />
        ...
        case 2: {
            return (
                <div className='mt-3 container'>
                    ...
                    <Image fluid src={process.env.PUBLIC_URL +"/example/anh-2-bai-toan-trong-cay.png"} />
        ...
        case 3: {
            return (
                <div className='mt-3 container'>
                    ...
                    <Image fluid src={process.env.PUBLIC_URL +"/example/anh-3-bai-toan-trong-cay.png"} />
        ...
        case 4: {
            return (
                <div className='mt-3 container'>
                    ...
                    <Image fluid src={process.env.PUBLIC_URL +"/example/anh-4-bai-toan-trong-cay.png"} />
